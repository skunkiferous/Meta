...
class BeanTest {
	...
	def void testChild() {
		...
		Assert.assertTrue("dtc.selected", dtc.selected)
		Assert.assertTrue("person.selected", person.selected)
		Assert.assertTrue("dtc.selectedRecursive", dtc.selectedRecursive)
		dtc.clearSelection(true, false)
		Assert.assertFalse("dtc.selected", dtc.selected)
		Assert.assertTrue("person.selected", person.selected)
		Assert.assertTrue("dtc.selectedRecursive", dtc.selectedRecursive)
